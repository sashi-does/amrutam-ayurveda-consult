...
import { register, login, createAppointment, sendOtpToMail, verify, getAppointments, lockSlot } from "../controllers/userController"
...
userRouter.post('/lock-slot', authMiddleware, lockSlot)
